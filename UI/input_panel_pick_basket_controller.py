...
# |----------------------------------------------------------------------------|
    def calibrate_pick_basket(self):
        ...
        robot_movement_params["gripper_width"] = pick_basket.arm('gripper_width')#XML
        robot_movement_params["gripper_jaw_thickness"] = pick_basket.arm('gripper_jaw_thickness') #XML
        robot_movement_params["z_pick_speed"] = pick_basket.arm('z_pick_speed') #XML
        robot_movement_params["z_place_speed"] = pick_basket.arm('z_place_speed') #XML
        robot_movement_params["z_offset_distance"] = pick_basket.arm('z_offset_distance') #XML
        robot_movement_params["z_place_pos"] = pick_basket.arm('z_place_pos') #XML
        robot_movement_params["row_direction"] = pick_basket.arm('row_direction') #XML
        robot_movement_params["column_direction"]= pick_basket.arm('column_direction') #XML

        basket_dimensions = {}
        basket_dimensions["max_row_count"] = pick_basket.basket_dims('max_row_count')
        basket_dimensions["max_column_count"] = pick_basket.basket_dims('max_column_count')
        basket_dimensions["row_distance"] = pick_basket.basket_dims('row_distance')
        basket_dimensions["column_distance"] = pick_basket.basket_dims('column_distance')
        basket_dimensions["length"] = pick_basket.basket_dims('length')
        basket_dimensions["width"] = pick_basket.basket_dims('width')
        basket_dimensions["height"] = pick_basket.basket_dims('height')
